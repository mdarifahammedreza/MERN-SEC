  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        Our Journey with the MERN
        </h2>
        <p
          className=" text-lg font-semibold text-gray-600 max-w-xl">
          Worked through HTML, CSS, JavaScript, React, Node.js, Express, MongoDB, and finally built a full-stack MERN application, deploying it online with authentication and product management features.
        </p>
      </div>
